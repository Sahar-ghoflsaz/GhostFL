...
#         # Block 1
#         self.conv1 = nn.Conv2d(3, 96, kernel_size=11, stride=4, padding=10)  
...
#     def __init__(self, out_features=10):
#         super(AlexNet_CIFAR10, self).__init__()
# 	    # First Block: More filters for RGB input
...
#         # Second Block
#         self.conv3 = nn.Conv2d(256, 384, kernel_size=3, stride=1, padding=1) # 16x16 -> 16x16
#         self.conv4 = nn.Conv2d(384, 384, kernel_size=3, stride=1, padding=1) # 16x16 -> 16x16
        
#         # Third Block
#         self.conv5 = nn.Conv2d(384, 256, kernel_size=3, stride=1, padding=1) # 8x8 -> 8x8
